...
| `@orkestrel/guide`      | `0.0.16` | L3    | `@orkestrel/contract` `^0.0.15`, `@orkestrel/markdown` `^0.0.12`                                                                                                                                                                                                                                                           |
...
| `@orkestrel/scaffold`   | `0.0.61` | L3    | `@orkestrel/console` `^0.0.11`, `@orkestrel/contract` `^0.0.15`, `@orkestrel/emitter` `^0.0.8`, `@orkestrel/markdown` `^0.0.12`, `@orkestrel/process` `^0.0.9`, `@orkestrel/template` `^0.0.5`                                                                                                                             |
